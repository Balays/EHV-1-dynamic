...
ggsave('Figures/Supp Figure SX TSS Kinetics Lit. Clusters REVIEW.jpg',  ggp, width = figw*0.8, height = figh, limitsize = F)
...
ggp <- cowplot::plot_grid(
  ...
  cowplot::plot_grid(
    ...
    nrow = 1, rel_widths = c(2, 1, 1, 1, 1, 1), align = 'vh', axis=c('tblr')
  ),
...
ggsave('Figures/Supp Figure SX TSS Kinetics DeNovo Clusters REVIEW.jpg',  ggp, width = figw*0.7, height = figh, limitsize = F)
...
ggsave('Figures/Supp Figure SX TSS Kinetics DeNovo Clusters REVIEW.jpg',  ggp, width = figw*0.8, height = figh, limitsize = F)
