...
### Mean and SD with linear connection - Figure 5
```{r, fig.show='hold',  fig.width = figw, fig.height = figh, eval=T}
...
ggsave('../EHV-1 dynamic article/Figures/Figure 5.jpg',       ggp, width = figw*0.8, height = figh, limitsize = F)
ggsave('../EHV-1 dynamic article/Figures/Figure 5.small.jpg', ggp, width = figw*0.6, height = figh, limitsize = F)
