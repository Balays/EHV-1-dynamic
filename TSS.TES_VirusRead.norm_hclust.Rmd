...
```{r}
sil_df[sil_width < 0.1 | gene_to_centroid_dist >= 0.5, gene]
...
cluster_dt <- unique(cluster_dt[,.(gene = gene, cluster=paste0('cluster_', cluster))])
...
cowplot::plot_grid(pclust, p, rel_widths = c(0.2,1), align = 'vh', axis = 'tlbr')
