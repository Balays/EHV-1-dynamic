...
ggsave('Figures/Figure 3 TSS-TES Kinetic Classes REVIEW.jpg',  ggp, width = figw*0.8, height = figh, limitsize = F)
...
ggp <- cowplot::plot_grid(
  ...
  cowplot::plot_grid(
    ...
    NULL, NULL,
    nrow = 1, rel_widths = c(3, 1, 2, 1, 1), align = 'vh', axis=c('tblr')
  ),
...
gg <- ggplot(DTuni[],
  ...
  facet_nested_wrap(~cluster, nrow = 4, scales = "free")


ggsave(paste0('Figures/Figure 5 REVIEW 2B.jpg'), gg, width = 6, height = 9, limitsize = F)
