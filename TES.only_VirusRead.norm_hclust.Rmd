...
ggsave('Figures/Supp Figure SX TES Kinetics Lit. Clusters REVIEW.jpg',  ggp, width = figw*0.8, height = figh, limitsize = F)
...
ggp <- cowplot::plot_grid(
  ...
  cowplot::plot_grid(
    mapfun(1, orf.perc.mean, cluster.freq, palette = palette,  ncol=6),
    nrow = 1, rel_widths = c(1), align = 'vh', axis=c('tblr')
  ),
  
  cowplot::plot_grid(
    mapfun(2, orf.perc.mean, cluster.freq, palette = palette,  ncol=2),
    NULL, 
    mapfun(3, orf.perc.mean, cluster.freq, palette = palette,  ncol=1),
    NULL, NULL, 
    nrow = 1, rel_widths = c(2, 1, 1, 1, 1), align = 'vh', axis=c('tblr')
  ),
  
  cowplot::plot_grid(
    mapfun(4, orf.perc.mean, cluster.freq, palette = palette,  ncol=1),
    NULL, 
    mapfun(5, orf.perc.mean, cluster.freq, palette = palette,  ncol=2),
    NULL, NULL,
    nrow = 1, rel_widths = c(1, 1, 2, 1, 1), align = 'vh', axis=c('tblr')
  ),
  
  cowplot::plot_grid(
    mapfun(6, orf.perc.mean, cluster.freq, palette = palette,  ncol=6),
    nrow = 1, rel_widths = c(1), align = 'vh', axis=c('tblr')
  ),
  
  cowplot::plot_grid(
    mapfun(7, orf.perc.mean, cluster.freq, palette = palette,  ncol=1),
    NULL, 
    mapfun(8, orf.perc.mean, cluster.freq, palette = palette,  ncol=4),
    nrow = 1, rel_widths = c(1, 1, 4), align = 'vh', axis=c('tblr')
  ),
  
  cowplot::plot_grid(
    mapfun(9, orf.perc.mean, cluster.freq, palette = palette,  ncol=6),
    nrow = 1, rel_widths = c(1), align = 'vh', axis=c('tblr')
  ),
  
  cowplot::plot_grid(
    mapfun(10, orf.perc.mean, cluster.freq, palette = palette,  ncol=4),
    NULL, NULL,
    nrow = 1, rel_widths = c(4, 1, 1), align = 'vh', axis=c('tblr')
  ),
  
  cowplot::plot_grid(
    mapfun(11, orf.perc.mean, cluster.freq, palette = palette,  ncol=6),
    nrow = 1, rel_widths = c(4, 3, 1), align = 'vh', axis=c('tblr')
  ),
  
  cowplot::plot_grid(
    mapfun(12, orf.perc.mean, cluster.freq, palette = palette,  ncol=1),
    NULL, NULL, 
    ggl_legend, ## Heres the color coding ~ aka legend
    NULL, NULL,
    nrow = 1, rel_widths = c(1, 1, 1, 1, 1, 1), align = 'vh', axis=c('tblr')
  ),
  
  rel_heights = c(1,1,1,2,1,2,1,2,1), ncol = 1, align = 'vh', axis=c('tblr')

)

ggsave('Figures/Supp Figure SX TES Kinetics deNovo Clusters REVIEW.jpg',  ggp, width = figw*0.6, height = figh, limitsize = F)
