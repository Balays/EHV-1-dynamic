...
cowplot::plot_grid(pclust, p, rel_widths = c(0.4, 1), align = 'vh', axis = 'tb')
...
```{r, fig.show='hold',  fig.width = 12, fig.height = 14, eval=T}
...
### Literature clusters
```{r, fig.show='hold',  fig.width = 7, fig.height = 12, eval=T}
