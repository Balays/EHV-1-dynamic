...
#ggsave('./Figures/Figure 7_REVIEW_ori.tif', Fig.isoforms, height = 12, width = 24, dpi = 300)
ggsave('./Figures/Figure 7_REVIEW.jpg', Fig.isoforms, height = 14, width = 24)
...
Fig.abunds1 <- cowplot::plot_grid(plotlist = list(
  ...
  mapfun('ORF58', orf.sum.perc, legend.position='right', title = 'B', what2plot = 'abund_only',
         breakseq=1500,
         recalc=T,
         strand_to_plot = '+',
         visfrom = 96600,
...
Fig.abunds2 <- cowplot::plot_grid(plotlist = list(
  mapfun('ORF8', orf.sum.perc, legend.position='right', title = 'D', what2plot = 'abund_only',
         breakseq=1000,
         recalc=T,
         strand_to_plot = '+',
  ...
  mapfun('NOIR', orf.sum.perc, legend.position='right', title = 'E', what2plot = 'abund_only',
         breakseq=1000,
         recalc=T,
         strand_to_plot = '+',
...
ggsave('./Figures/Figure 3_REVIEW.jpg', Fig.splice, height = 14, width = 24)
...
#ggsave('./Figures/Figure 3_REVIEW_ori.tif', Fig.splice, height = 10, width = 24, dpi = 300)
ggsave('./Figures/Supp Fig S3 REVIEW.jpg', Fig.splice, height = 12, width = 16)
