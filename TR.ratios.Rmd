...
Fig.abunds1 <- cowplot::plot_grid(plotlist = list(
  mapfun('ORF11', orf.sum.perc, legend.position='bottom', title = 'A', what2plot = 'abund_only', legend.nrow=2,
         recalc=F,
         strand_to_plot = '+',
...
Fig.isoforms1 <- cowplot::plot_grid(Fig.abunds1, Fig.annots1, ncol=2, rel_widths = c(1, 0.85), align = 'vh', axis = 'l')
...
Fig.isoforms <- cowplot::plot_grid(Fig.isoforms1, Fig.isoforms2, ncol=2, rel_widths = c(0.85, 1))
...
#Fig.abunds2 <- cowplot::plot_grid(plotlist = list(
  ...
  mapfun('ORF14', orf.sum.perc, legend.position='right', what2plot = 'abund_only', title = 'E',
         ...
         visfrom  = 14980,    # min(TR.merged.data.gene[gene == 'ORF13' & strand == '+', start]) - vis_win,
         visto    = 21600 ),   # max(TR.merged.data.gene[gene == 'ORF13' & strand == '+', end  ]) + vis_win),
  mapfun('ORF19', orf.sum.perc, legend.position='right', what2plot = 'abund_only', title = 'F',
         recalc=F,
         strand_to_plot = '+',
