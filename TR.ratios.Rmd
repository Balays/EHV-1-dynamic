...
Torma_canonic <- Torma_et_al[Canonic == '*' & `Transcript category` == 'Monocistronic', .(Gene, `Transcript ID`)]


Torma_et_al[`Transcript category` == ',`Transcript ID`]
...
cowplot::plot_grid(gg1, gg2, gg3, nrow = 1) + ggtitle('all transcripts')
...
cowplot::plot_grid(gg1, gg2, gg3, nrow = 1) + ggtitle('Tombácz et al transcripts')
...
cowplot::plot_grid(gg1, gg2, gg3, nrow = 1) + ggtitle('Putative mRNAs')

ggsave('Putative mRNAs.venn.jpg', width=12, height=7)
```
