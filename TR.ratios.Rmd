...
ggsave('./Figures/Supp Fig S12A.pdf', Fig.all.Ori, height = 16, width = 10)

#Fig.all.Ori
```


### Supp Fig S12B - PRV raRNAs
```{r, fig.show='hold',  fig.width = figw, fig.height = figh, eval=T}
...
ggsave('./Figures/Supp Fig S12B.tiff', Fig.PRV.Ori, height = 18, width = 10)
